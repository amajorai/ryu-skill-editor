...
// Build the Skill Editor Companion to ONE self-contained HTML (Path B). A single
...
// design system. The output is `dist/index.html`, shipped verbatim as the plugin's
// `ui_code`.
...
export default defineConfig({
	...
	build: {
		...
		rollupOptions: {
			input: { "skill-editor": resolve(here, "index.html") },
